...
def init_db():
    ...
    try:
        if conn.backend == "postgres":
            ...
            cur.execute("ALTER TABLE device_states ADD COLUMN IF NOT EXISTS last_event_ts BIGINT")
            cur.execute("ALTER TABLE device_states ADD COLUMN IF NOT EXISTS last_event_type TEXT")
            cur.execute("ALTER TABLE device_states ADD COLUMN IF NOT EXISTS last_still_ts BIGINT")
            ...
            cur.execute("ALTER TABLE beacon_states ADD COLUMN IF NOT EXISTS last_event_ts BIGINT")
            cur.execute("ALTER TABLE beacon_states ADD COLUMN IF NOT EXISTS last_event_type TEXT")
            cur.execute("ALTER TABLE beacon_states ADD COLUMN IF NOT EXISTS last_still_ts BIGINT")
